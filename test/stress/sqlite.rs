...
pub fn sqlite3_package() -> BindingPackage {
    ...
    let stmt_ptr_ptr = BindingType::ptr(BindingType::ptr(BindingType::RecordRef(
        "sqlite3_stmt".into(),
    )));
    ...
    let functions: Vec<FunctionSpec> = vec![
        ...
        (
            ...
            vec![
                ...
                ("arg", void_ptr.clone()),
                ("errmsg", BindingType::ptr(char_ptr.clone())),
            ],
            BindingType::Int,
            false,
        ),
        ...
        (
            ...
            vec![("db", db_ptr.clone()), ("ms", BindingType::Int)],
            BindingType::Int,
            false,
        ),
        (
            ...
            vec![
                ...
                (
                    ...
                    BindingType::FunctionPointer {
                        return_type: Box::new(BindingType::Int),
                        parameters: vec![void_ptr.clone(), BindingType::Int],
                        variadic: false,
                    },
                ),
                ("arg", void_ptr.clone()),
        ...
        (
            ...
            vec![
                ("db", db_ptr.clone()),
                ("sql", const_char_ptr.clone()),
                ("nByte", BindingType::Int),
                ("ppStmt", stmt_ptr_ptr.clone()),
                ("pzTail", BindingType::ptr(const_char_ptr.clone())),
            ],
            BindingType::Int,
            false,
        ),
        ...
        (
            ...
            vec![
                ("stmt", stmt_ptr.clone()),
                ("idx", BindingType::Int),
                ("val", const_char_ptr.clone()),
                ("n", BindingType::Int),
                (
                    "destructor",
                    BindingType::FunctionPointer {
                        return_type: Box::new(BindingType::Void),
                        parameters: vec![void_ptr.clone()],
                        variadic: false,
                    },
                ),
            ],
        ...
        (
            "sqlite3_bind_null",
            vec![("stmt", stmt_ptr.clone()), ("idx", BindingType::Int)],
            BindingType::Int,
            false,
        ),
        (
        ...
        (
            ...
            vec![("stmt", stmt_ptr.clone()), ("name", const_char_ptr.clone())],
            BindingType::Int,
            false,
        ),
        // column
        ...
        (
            "sqlite3_malloc",
            vec![("n", BindingType::Int)],
            void_ptr.clone(),
            false,
        ),
        (
            "sqlite3_malloc64",
            vec![("n", BindingType::ULongLong)],
            void_ptr.clone(),
            false,
        ),
        (
            "sqlite3_realloc",
            vec![("ptr", void_ptr.clone()), ("n", BindingType::Int)],
            void_ptr.clone(),
            false,
        ),
        (
    ...
    pkg.items.push(BindingItem::Enum(EnumBinding {
        ...
        variants: vec![
            EnumVariant {
                name: "SQLITE_INTEGER".into(),
                value: Some(1),
            },
            EnumVariant {
                name: "SQLITE_FLOAT".into(),
                value: Some(2),
            },
            EnumVariant {
                name: "SQLITE_BLOB".into(),
                value: Some(4),
            },
            EnumVariant {
                name: "SQLITE_NULL".into(),
                value: Some(5),
            },
            EnumVariant {
                name: "SQLITE_TEXT".into(),
                value: Some(3),
            },
        ],
        representation: None,
