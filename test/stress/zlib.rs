...
pub fn zlib_package() -> BindingPackage {
    ...
    pkg.items.push(BindingItem::Record(RecordBinding {
        ...
        fields: Some(vec![
            ...
            FieldBinding {
                name: Some("avail_out".into()),
                ty: BindingType::UInt,
                bit_width: None,
                layout: None,
            },
            FieldBinding {
                name: Some("total_out".into()),
                ty: BindingType::ULong,
                bit_width: None,
                layout: None,
            },
            ...
            FieldBinding {
                name: Some("zalloc".into()),
                ty: BindingType::FunctionPointer {
                    return_type: Box::new(BindingType::ptr(BindingType::Void)),
                    parameters: vec![
            ...
            FieldBinding {
                name: Some("data_type".into()),
                ty: BindingType::Int,
                bit_width: None,
                layout: None,
            },
            FieldBinding {
                name: Some("adler".into()),
                ty: BindingType::ULong,
                bit_width: None,
                layout: None,
            },
    ...
    pkg.items.push(BindingItem::Record(RecordBinding {
        ...
        fields: Some(vec![
            ...
            FieldBinding {
                name: Some("extra_len".into()),
                ty: BindingType::UInt,
                bit_width: None,
                layout: None,
            },
            FieldBinding {
                name: Some("extra_max".into()),
                ty: BindingType::UInt,
                bit_width: None,
                layout: None,
            },
    ...
    for (name, params, ret, variadic) in [
        (
            ...
            vec![
                (
                    "strm",
                    BindingType::ptr(BindingType::RecordRef("z_stream".into())),
                ),
        ...
        (
            ...
            vec![
                ...
                ("destLen", BindingType::ptr(BindingType::ULong)),
                (
                    "source",
                    BindingType::Pointer {
                        pointee: Box::new(BindingType::UChar),
        ...
        (
            "compressBound",
            vec![("sourceLen", BindingType::ULong)],
            BindingType::ULong,
            false,
        ),
        (
